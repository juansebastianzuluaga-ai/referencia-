    ...
    <tr>
      <td align="center">
        <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
          ...
          <!-- Barra de estado -->
          <tr>
            <td style="background:#eef2ff;padding:16px 40px;border-bottom:2px solid #a5b4fc;">
              <p style="margin:0;font-size:15px;font-weight:bold;color:#4338ca;text-align:center;">
                🏁 Solicitud de referencia COMPLETADA
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <p style="margin:0 0 20px;font-size:14px;color:#555;line-height:1.7;">
                Le informamos que el paciente llegó a la institución y fue atendido. La solicitud quedó marcada como <strong style="color:#4338ca;">completada</strong>.
              </p>
